...
export default function AddCarForm({ open, setOpen }: { open: boolean, setOpen: (open: boolean) => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="dark h-[92vh] overflow-hidden w-full min-w-2xl">
        <DialogHeader>
      ...
      <div className="relative flex-1 min-h-0">
        <div className="poiner-events-none absolute top-0 left-0 w-full h-10 bg-gradient-to-b from-background to-transparent z-10" />

        <div className="h-full overflow-y-auto no-scrollbar px-1 py-6">
          ...
          <FieldSet className="w-full max-w-lg mt-8 mx-auto justify-center">
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <FieldContent>
                  <Input value={year} min={0} onChange={(e) => setYear(e.target.value)} placeholder="Year" type="number" className="border p-2 rounded" />
                </FieldContent>
              </Field>
              <Field>
              ...
              <Field>
                ...
                <FieldContent>
                  <Input value={hp} min={0} onChange={(e) => setHp(e.target.value)} placeholder="HP" type="number" className="border p-2 rounded" />
                </FieldContent>
              </Field>
              <Field>
                <FieldLabel>Mileage</FieldLabel>
                <FieldContent>
                  <Input value={mileage} min={0} onChange={(e) => setMileage(e.target.value)} placeholder="Mileage" type="number" className="border p-2 rounded" />
                </FieldContent>
              </Field>
              <Field>
                <FieldLabel>Seats</FieldLabel>
                <FieldContent>
                  <Input value={seats} min={0} max={7} onChange={(e) => setSeats(e.target.value)} placeholder="Seats" type="number" className="border p-2 rounded" />
                </FieldContent>
              </Field>
              <Field>
              ...
              <Field>
                ...
                <FieldContent>
                  <Input value={pricePerDay} min={0} onChange={(e) => setPricePerDay(e.target.value)} placeholder="Price per Day" type="number" className="border p-2 rounded" />
                </FieldContent>
              </Field>
